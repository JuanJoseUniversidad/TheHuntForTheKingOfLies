...
public:
	...
	const bool& Mace() const { return Mace_; }
	const bool& Claws() const { return Claws_; }
	...
	void operator=(const EALSOverlayState NewAction)
	{
		...
		Reload_ = State == EALSOverlayState::Reload;
		Sword_ = State == EALSOverlayState::Sword;
		Mace_ = State == EALSOverlayState::Mace;
		Claws_ = State == EALSOverlayState::Claws;
